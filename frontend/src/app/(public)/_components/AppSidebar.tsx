    ...
    <Sidebar className="hidden md:flex border-r border-sidebar-border bg-sidebar h-full">
      ...
      <SidebarHeader className="h-18 flex items-center justify-center border-b border-sidebar-border/50 px-4">
        <Link href="/" className="flex items-center gap-3 w-full hover:opacity-90 transition-opacity">
          <div className="bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 flex size-9 items-center justify-center rounded-xl shadow-sm ring-1 ring-black/5 dark:ring-white/10">
            <Leaf className="size-5 text-white fill-white/20" />
          </div>
                    ...
                    {displayedCommunities.map((community) => {
                      ...
                      return (
                        <SidebarMenuItem key={community._id}>
                          <SidebarMenuButton 
                            asChild 
                            className={`h-11 px-2.5 transition-all duration-200 group ${
